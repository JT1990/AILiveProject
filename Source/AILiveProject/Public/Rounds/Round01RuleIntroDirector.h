...
#include "Round01RuleIntroDirector.generated.h"
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FRound01CompletedDelegate);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FRound01FailedDelegate, FString, Reason);

UENUM(BlueprintType)
enum class ERound01State : uint8
{
	Idle,
	OpeningDoors,
	NPCsMovingToTV,
...
class AILIVEPROJECT_API ARound01RuleIntroDirector : public AActor
{
	GENERATED_BODY()

public:
	ARound01RuleIntroDirector();

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AILiveProject|Round01|Input")
	bool bEnableKeyTrigger = true;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AILiveProject|Round01|Input")
	FKey StartKey;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AILiveProject|Round01|Actors")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AILiveProject|Round01|Doors")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AILiveProject|Round01|Movement")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AILiveProject|Round01|Video")
	float VideoFallbackTimeoutSeconds = 600.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AILiveProject|Round01|Debug")
	bool bDebugPrintScreen = true;

	UPROPERTY(BlueprintAssignable, Category = "AILiveProject|Round01")
	FRound01CompletedDelegate OnRound01Completed;

	UPROPERTY(BlueprintAssignable, Category = "AILiveProject|Round01")
	FRound01FailedDelegate OnRound01Failed;

	UFUNCTION(BlueprintCallable, Category = "AILiveProject|Round01")
	bool BeginRound01();

	UFUNCTION(BlueprintCallable, Category = "AILiveProject|Round01")
	void CancelRound01();

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "AILiveProject|Round01")
	bool IsRound01Running() const { return SceneState != ERound01State::Idle; }

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "AILiveProject|Round01")
	ERound01State GetSceneState() const { return SceneState; }
...
private:
	...
	void CompleteRound01();
	void FailRound01(const FString& Reason);
	...
	ERound01State SceneState = ERound01State::Idle;
