...
- `references/log-triage.md` — log filtering patterns and common error signatures
- `references/minimal-repro-template.md` — template for structuring a minimal reproduction case
- `references/project-adapter.md` — project-specific asset paths and config locations
- `scripts/scan_output_log.py` — run to scan and filter the UE output log for error patterns
- `scripts/quick_asset_check.py` — run to verify asset existence and dependency health
