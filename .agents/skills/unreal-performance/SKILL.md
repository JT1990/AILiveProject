...
description: Performance and optimization via Monolith MCP. Triggers on performance, FPS, frame time, GPU, draw calls, shader complexity, INI, optimization. Config auditing, shader stats, draw call analysis.
---
