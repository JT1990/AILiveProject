---
name: unreal-build
description: Build and compile Unreal Engine via Monolith MCP. Triggers on build, compile, Live Coding, hot reload, UBT, build error, compile error. Determines whether to use Live Coding or full UBT rebuild.
---
