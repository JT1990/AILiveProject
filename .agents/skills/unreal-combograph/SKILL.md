...
description: ComboGraph plugin via Monolith MCP. Triggers on ComboGraph, combo system, combo ability, attack combo. Create and edit combo graphs, nodes, edges, effects, cues, scaffold combo abilities.
---
