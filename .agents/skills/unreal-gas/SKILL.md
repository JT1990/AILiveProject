---
name: unreal-gas
description: Gameplay Ability System via Monolith MCP. Triggers on GAS, GameplayAbility, GameplayEffect, AttributeSet, ASC, AbilitySystemComponent, GameplayTag, gameplay cue, targeting, input binding.
---
