...
description: Blueprints via Monolith MCP. Triggers on Blueprint, BP, widget blueprint, level blueprint, variable, node, graph, DataTable, struct, enum, timeline, CDO. Read, create, modify, and compile Blueprint assets.
---
