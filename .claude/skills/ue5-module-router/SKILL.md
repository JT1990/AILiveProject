...
- `references/ue5-module-routing-table-final.csv` — load this when resolving module-to-skill mappings
- `references/routing-policy.md` — routing tie-break rules and fallback policy

# Output Example

```json
{
  "primary_skill": "ue5-cpp-gameplay",
  "secondary_skill": "ue5-architecture",
  "recommended_mcp_tools": ["blueprint_query", "asset_search"],
  "route_confidence": 0.92,
  "route_reason": "Module 'GameplayAbilities' maps to cpp-gameplay; cross-module dependency on Core suggests architecture review as secondary"
}
```