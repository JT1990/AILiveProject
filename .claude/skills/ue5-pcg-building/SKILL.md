...
description: UE5.6/UE5.7 PCG building generation for modular buildings, blockouts, and facade rules. Use when requests involve PCG, Shape Grammar, lot-based building spawn, deterministic seeds, density/filter pipelines, or reusable PCG graphs.
---
