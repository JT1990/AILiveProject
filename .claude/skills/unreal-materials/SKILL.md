...
description: Materials via Monolith MCP. Triggers on material, shader, PBR, material instance, material graph, HLSL, material function. PBR setup, graph building, instances, templates, HLSL nodes, validation.
---
