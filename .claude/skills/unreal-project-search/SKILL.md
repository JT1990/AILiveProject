...
description: Asset search via Monolith MCP. Triggers on find asset, search, where is, references, dependencies, discover content. Full-text search, asset discovery, reference tracing, type filtering.
---
