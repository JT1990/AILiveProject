...
description: Debug Unreal Engine via Monolith MCP. Triggers on build error, compile error, crash, output log, debug, stack trace, assertion. Log search, crash context, Live Coding builds, UE error patterns.
---
