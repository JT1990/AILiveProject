...
description: Logic Driver Pro plugin via Monolith MCP. Triggers on Logic Driver, state machine, FSM, state transition, runtime state. State machines, states, transitions, runtime PIE control, JSON spec builds.
---
