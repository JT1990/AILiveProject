...
description: UE5.6/UE5.7 world interaction for pickups, spawners, overlap/trace checks, and visual feedback. Use when requests involve interactive actors, spawn logic, pickup behavior, radius checks, feedback, or actor lifecycle control.
---
