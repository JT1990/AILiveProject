...
description: Animation assets via Monolith MCP. Triggers on animation, AnimBP, montage, blend space, IKRig, IK Retargeter, Control Rig, skeleton, bone track, notify. Sequences, montages, blend spaces, ABP, skeletons.
---
