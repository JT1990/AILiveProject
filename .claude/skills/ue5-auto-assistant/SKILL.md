...
- `references/natural-language-triggers.md` — natural language to skill intent mapping
- `references/mcp-skill-mapping.md` — MCP tool to skill mapping table
- `references/beginner-smoke-prompts.md` — example prompts for testing routing accuracy

# Output Example

```json
{
  "primary_skill": "ue5-blueprint-workflow",
  "secondary_skill": null,
  "recommended_mcp_tools": ["blueprint_feature_build", "blueprint_modify"],
  "route_confidence": 0.95,
  "route_reason": "User asked to add a jump mechanic — maps to Blueprint workflow; no module name given so intent-based routing used"
}
```