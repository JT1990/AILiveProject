...
3. Docs/Roadmap/T01_protocol_skeleton.md ——本卡完整详设（含验收清单与已知坑）
4. Docs/memory_principles.md 关键章节：§〇 硬约束 1–6、§一 两层架构、§2.1 数据层不变量、§4.1.1–§4.1.2、§4.1.5、§5.1、§5.4.1、§7.3
5. Docs/PRD.md：「项目核心」「AI 心智决策系统」「让博弈对 AI 自己而言"重要"」三节
6. CLAUDE.md（项目根）
